...
### File Setup
After placing the downloaded folder in your Google Drive, it should look like this before running anything:
```
MyDrive/
└── fismo-detection/
    ├── raw_annotated_data/
...
After running all cells, your `fismo-detection/` folder will look like this:
```
MyDrive/
└── fismo-detection/
    ├── raw_annotated_data/
